...
<!--
     ...
     file: local:///cf/SQL-Injection-Patterns-CF.xml
...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="dpconfig:SQLPatternFile" select="'local:///cf/SQL-Injection-Patterns-CF.xml'"/>
    <dp:param name="dpconfig:SQLPatternFile" type="dmFSFile" xmlns="">
        ...
        <default>local:///cf/SQL-Injection-Patterns-CF.xml</default>
